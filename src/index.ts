...
<html lang="en">
  <head>
    ...
    <title>Maintainence | ${appName}</title>
    <style>
    ...
    <div class="vh">
      <div>
        <div class="wrap">
          ...
          <h2>Sorry for the inconvenience.<br>Our website is currently undergoing scheduled maintenance.</h2>
          <br><br>
          <p>Started: ${now.toUTCString()}</p>
          ${eta ? raw('<p>ETA: ' + eta + '</p>'): ''}
